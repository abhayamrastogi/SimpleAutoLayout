...
#ifdef DEBUG
#define UTLog(...) NSLog(__VA_ARGS__)
#else
#define UTLog(...)
#endif
...
#pragma mark- Color
#define UTColor(r, g, b) [UIColor colorWithRed:(r)/255.0 green:(g)/255.0 blue:(b)/255.0 alpha:1.0]
#define NAVIGATION_BAR_COLOR	[UIColor colorWithRed:33.0f/255.0f green: 169.0f/255.0f blue:244.0f/255.0f alpha:1]

#define GLOBAL_TINTCOLOR	[UIColor colorWithRed:122.0f/255.0f green: 57.0f/255.0f blue:244.0f/255.0f alpha:1]
